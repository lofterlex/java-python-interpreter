...
public class FunctionCallExpression extends Expression<Object>{
    ...
    private List<PyObject> parameterValue;
    ...
    @Override
    public Object evaluate(ProgramState programState) {
        ...
        for (int i = 0; i < parameterValue.size(); i++) {
            PyObject val = parameterValue.get(i);
        ...
        for (Statement functionStatement : functionStatements) {
            ...
            functionStatement.run(functionState);
        }
